...
public class TopologyMetadataPropertyKeys {
    ...
    public static final String REST_ENTRIES_METADATA = "REST_ENTRIES_METADATA";
    public static final String CLOUD_ID = "CLOUD_ID";
    public static final String REPRESENTATION = "REPRESENTATION_NAME";
    public static final String VERSION = "REPRESENTATION_VERSION";
    public static final String MARKED_AS_DELETED = "FOR_DELETION";
}
